...
type
  ...
  TCustomZStream = class(TSdaStream)
  private
    FStream: TSdaStream;
    FStreamPos: Int64;
  ...
  protected
    constructor Create(stream: TSdaStream);
  ...
  public
    constructor Create(dest: TSdaStream; compressionLevel: TZCompressionLevel = zcDefault); overload;
    // CG: Add overloaded constructor for old parameter type and order
    constructor Create(compressionLevel: TCompressionLevel; dest: TSdaStream); overload;
  ...
  public
    constructor Create(source: TSdaStream);
    destructor Destroy; override;
    function Read(var buffer; count: Longint): Longint; override;
    function Write(const buffer; count: Longint): Longint; override;
    function Seek(offset: Int64; origin: TSeekOrigin): Int64; override;
...
procedure ZCompressStream(inStream, outStream: TSdaStream;
  level: TZCompressionLevel = zcDefault); overload;
// CG: Add overload to take old enum type
procedure ZCompressStream(inStream, outStream: TSdaStream;
  level: TCompressionLevel); overload; inline;

procedure ZDecompressStream(inStream, outStream: TSdaStream);
...
constructor TCustomZStream.Create(stream: TSdaStream);
begin
  inherited Create;
  FStream := stream;
...
constructor TZCompressionStream.Create(dest: TSdaStream;
...
constructor TZCompressionStream.Create(compressionLevel: TCompressionLevel; dest: TSdaStream);
begin
...
function TZCompressionStream.Seek(offset: Int64; origin: TSeekOrigin): Int64;
begin
...
constructor TZDecompressionStream.Create(source: TSdaStream);
begin
...
function TZDecompressionStream.Seek(Offset: Int64; Origin: TSeekOrigin): Int64;
var
...
begin
  ...
  begin
    if origin = soBeginning then Dec(offset, FZStream.total_out);
